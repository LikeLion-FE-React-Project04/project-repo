      ...
      <div>
        <AccordionItem index={1} width="1024px">
          ...
          <div className={styles.panel}>
            ...
            <br />
            칼리는 상품에 대한 고객 여러분의 생생한 의견을 듣고 더 나은 상품을 준비하기 위해 상품 후기 게시판을 운영하고 있습니다.<br />
            <br />
        ...
        <AccordionItem index={2} width="1024px">
          ...
          <div className={styles.panel}>
            고객님 안녕하세요. 칼리 입니다.<br />
            적립금 지급 정책을 안내드리니 칼리 이용에 참고 부탁드립니다.<br />
            <br />
            ■ 적립금 지급 정책 ■<br />
            <br />
            1. 일반 후기<br />
            ...
            *당첨 상품 및 그 주의 Best 후기는 후기 게시판에서 확인하실 수 있습니다.<br />
            ...
            칼리는 믿을 수 있는 후기문화를 함께 만들어가고자 합니다. 따라서 후기 내용이 아래에 해당하는 경우에는 검토 후 삭제 및 적립금 회수 조치될 수 있습니다.<br />
            <br />
