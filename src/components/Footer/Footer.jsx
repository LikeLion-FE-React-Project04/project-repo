    ...
    <>
      <footer className={styles.footerWrap}>
          ...
          <article className={styles.footerCustomerInfo}>
            ...
            <div className={styles.customerInquiryEmail}>
              <p className={styles.nonMemberInquiry}>비회원 문의 : 
                <Link aria-label="비회원 문의를 하기 위한 Email" className={styles.nonMemberEmail} to="/"> help@karlycorp.com</Link>
              </p>
              <p className={styles.nonMemberLargeOrder}>비회원 대량주문 문의 : 
                <Link aria-label="비회원 대량주문을 하기 위한 Email" className={styles.nonMemberEmail} to="/"> help@karlycorp.com</Link>
              </p>
            </div>
          </article>
          <article className={styles.footerCompanyInfo}>
            <nav className={styles.footerNavigation}>
              <Link aria-label="칼리소개 보기" to="/">칼리소개</Link>
              <Link aria-label="칼리소개 영상 보기" to="/">칼리소개영상</Link>
              <Link aria-label="인재채용 정보 확인하기" to="/">인재채용</Link>
              <Link aria-label="이용약관 확인하기" to="/">이용약관</Link>
              <Link aria-label="개인정보처리방침 확인하기" to="/">개인정보처리방침</Link>
              <Link aria-label="이용안내" to="/">이용안내</Link>
            </nav>
            <div className={styles.footerCompanyIntroduce}>
              <p>
                ...
                <span className={styles.footerBar}>|</span>
                <Link aria-label="사업자 정보 확인하러 가기" style={{color: "#5F0080"}} to="/">사업자정보 확인</Link>
              </p>
              <p>
              ...
              <p>
                입점문의 : <Link aria-label="입정문의하기" style={{color: "#5F0080"}} to="/">입정문의하기</Link>
                <span className={styles.footerBar}>|</span>
                제휴문의 : <Link aria-label="제휴문의 Email" style={{color: "#5F0080"}} to="/">business@karlycorp.com</Link>
              </p>
              <p>채용문의 : recruit@karlycorp.com</p>
              <p>팩스 : 070 - 7500 - 6098</p>
            </div>
            <div className={styles.footerCompanySns}>
              <Link aria-label="컬리 네이버 블로그 바로가기" to="/">
                <Blog alt="" />
              </Link>
              <Link aria-label="컬리 페이스북 바로가기" to="/">
                <Facebook alt="" />
              </Link>
              <Link aria-label="컬리 인스타그램 바로가기" to="/">
                <Instagram alt="" />
              </Link>
              <Link aria-label="컬리 네이버포스트 바로가기" to="/">
                <Naver alt="" />
              </Link>
              <Link aria-label="컬리 유튜브 바로기" to="/">
                <Youtube alt="" />
              </Link>
            </div>
          </article>
        ...
        <section className={styles.footerAllianceWrap}>
          ...
          <button className={styles.allianceBtn}>
            <Privacy alt="E.privacy plus 로고" style={{width:'34px', height:'34px'}} />
            <p>
              개인정보보호 우수 웹사이트<br/>
          ...
          <button className={styles.allianceBtn}>
            <Tosspayments alt="Toss payments 로고" style={{width:'102px', height:'32px'}} />
            <p>
              토이페이먼츠 구매안전(에스크로)<br/>서비스를 이용하실 수 있습니다.
            </p>
          </button>
          <button className={styles.allianceBtn}>
            <Wooribank alt="우리은행 로고" style={{width:'34px', height:'34px'}} />
            <p>
